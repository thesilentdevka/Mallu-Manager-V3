...
from mallu-manager-v3v3 import TIGERS, WOLVES, dispatcher
from mallu-manager-v3v3.modules.sql.approve_sql import is_approved
from mallu-manager-v3v3.modules.helper_funcs.chat_status import (
    bot_admin, can_restrict, connection_status, is_user_admin, user_admin,
    user_admin_no_reply)
from mallu-manager-v3v3.modules.log_channel import loggable
from mallu-manager-v3v3.modules.sql import antiflood_sql as sql
...
from mallu-manager-v3v3.modules.helper_funcs.string_handling import extract_time
from mallu-manager-v3v3.modules.connection import connected
from mallu-manager-v3v3.modules.helper_funcs.alternate import send_message
FLOOD_GROUP = 3
