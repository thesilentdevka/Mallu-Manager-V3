...
from mallu-manager-v3 import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from mallu-manager-v3.__main__ import STATS, TOKEN, USER_INFO
import mallu-manager-v3.modules.sql.userinfo_sql as sql
from mallu-manager-v3.modules.disable import DisableAbleCommandHandler
from mallu-manager-v3.modules.sql.global_bans_sql import is_user_gbanned
from mallu-manager-v3.modules.sql.afk_sql import is_afk, check_afk_status
from mallu-manager-v3.modules.sql.users_sql import get_user_num_chats
from mallu-manager-v3.modules.helper_funcs.chat_status import sudo_plus
from mallu-manager-v3.modules.helper_funcs.extraction import extract_user
from mallu-manager-v3 import telethn as EmiliaTelethonClient
