...
from mallu-manager-v3.extrastuff import SUDOERS
from mallu-manager-v3 import LOG_GROUP_ID
from mallu-manager-v3 import pgram as app 
from mallu-manager-v3.arqclient import arq
from mallu-manager-v3.utils.keyboard import ikb
from mallu-manager-v3.core.tasks import _get_tasks_text, all_tasks, rm_task
from mallu-manager-v3.core.types import InlineQueryResultCachedDocument
from mallu-manager-v3.modules.info import get_chat_info, get_user_info
from mallu-manager-v3.modules.media import download_youtube_audio
from mallu-manager-v3.utils.functions import test_speedtest
from mallu-manager-v3.utils.pastebin import paste
...
async def inline_help_func(__help__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/IzumiCypherX/mallu-manager-v3"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[Emilia✨](https://github.com/IzumiCypherX/mallu-manager-v3):**
**RoBot:** `{bot_state}`
