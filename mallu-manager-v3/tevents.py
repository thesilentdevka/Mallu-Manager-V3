...
from mallu-manager-v3v3v3v3 import MONGO_DB_URI
from mallu-manager-v3v3v3v3 import telethn

client = MongoClient()
client = MongoClient(MONGO_DB_URI)
db = client["mallu-manager-v3v3v3v3"]
gbanned = db.gban
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import mallu-manager-v3v3v3v3.tevents

        path = Path(f"mallu-manager-v3v3v3v3/modules/{shortname}.py")
        name = "mallu-manager-v3v3v3v3.modules.{}".format(shortname)
...
path = "mallu-manager-v3v3v3v3/modules/*.py"
