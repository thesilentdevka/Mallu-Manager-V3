...
if ENV:
    ...
    from mallu-manager-v3.config import Development as Config
    TOKEN = Config.TOKEN
...
db = mongo_client.mallu-manager-v3
...
from mallu-manager-v3.modules.helper_funcs.handlers import (CustomCommandHandler,
...
INFO GATHERED!
Client: Emilia Pyro
Copyright: (c) 2021 mallu-manager-v3
"""
print(end_credits)
